...
import UploadPage from '../plugins/upload-page';
...
export default function UploadViewCard() {
    ...
    return (
        ...
        <div className="group relative flex flex-col bg-mixed-300 min-w-48 h-48 rounded-md gap-4 p-4 hover:bg-mixed-300/70" onClick={() => setActiveContent(activeTab, <UploadPage />)}>
